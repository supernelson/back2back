...
//		World.markerDrawable_directionIndicator = new AR.ImageResource("assets/indi.png");
	...
	*/
	...
	onMarkerSelected: function onMarkerSelectedFn(marker) {
		...
		var distanceToUserValue = (marker.distanceToUser > 999) ? ((marker.distanceToUser / 1000).toFixed(2) + " miles") : (Math.round(marker.distanceToUser) + " m");
	...
	updateRangeValues: function updateRangeValuesFn() {
		...
		var maxRangeValue = (maxRangeMeters > 999) ? ((maxRangeMeters / 1000).toFixed(2) + " miles") : (Math.round(maxRangeMeters) + " m");
	...
	*/
	...
	requestDataFromServer: function requestDataFromServerFn(lat, lon) {
		...
		var serverUrl = ServerInformation.POIDATA_SERVER + "?" + ServerInformation.POIDATA_SERVER_ARG_LAT + "=" + lat + "&" + ServerInformation.POIDATA_SERVER_ARG_LON + "=" + lon + "&" + ServerInformation.POIDATA_SERVER_ARG_NR_POIS + "=2";
	...
	sortByDistanceSorting: function(a, b) {
        var miles = (a.distanceToUser - b.distanceToUser) * (0.621371);
		return miles;
	},

	// helper to sort places by distance, descending
	sortByDistanceSortingDescending: function(a, b) {
        var miles2 = (b.distanceToUser - a.distanceToUser) * (0.621371);
        return miles2;
	}
